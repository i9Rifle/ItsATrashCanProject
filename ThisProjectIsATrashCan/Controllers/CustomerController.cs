...
namespace ThisProjectIsATrashCan.Controllers
{
    public class CustomerController : Controller
    {
        ...
        {
            ViewData["AccountId"] = new SelectList(_context.Set<Address>(), "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,UserId,AddressId,AccountId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,UserId,AddressId,AccountId")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
